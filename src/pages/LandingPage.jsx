      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <section>
            ...
            <p className="text-sm text-gray-500 mb-4 text-center italic">
              Penggunaan Sistem Inventaris ANTARA memberikan manfaat berupa:
            </p>
            <Card>
              <ol className="list-decimal list-inside text-sm text-gray-600 space-y-2">
                <li>Optimalisasi penggunaan dan pemeliharaan aset kantor.</li>
                <li>Proses administrasi peminjaman yang lebih cepat dan mudah.</li>
                <li>Kemudahan dalam melacak keberadaan dan kondisi barang.</li>
                <li>Penyajian laporan yang cepat untuk kebutuhan manajemen.</li>
                <li>Keamanan data inventaris yang lebih terjamin secara digital.</li>
              </ol>
            </Card>
          </section>
        </div>
