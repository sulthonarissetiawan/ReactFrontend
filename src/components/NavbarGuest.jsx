    ...
    return (
        <nav className="flex justify-between items-center px-12 py-4 bg-white border-b border-black sticky top-0 z-50">
            ...
            <div className="flex gap-8 text-sm text-gray-700">
                <Link to="/" className="hover:text-[#991B1F] transition-colors">Tentang</Link>
                <Link to="/register" className="hover:text-[#991B1F] transition-colors">Daftar</Link>
                <Link to="/login" className="hover:text-[#991B1F] transition-colors">Masuk</Link>
            </div>
        </nav>
    );
};
